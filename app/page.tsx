      ...
      <section className="nova-content">
        ...
        <div className="workspace">
          <div className="workspace-heading">
            <div><p className="micro-label">INTELLIGENCE CORE <span>● ONLINE</span></p><h1>Good morning, Alex.</h1><p className="subheading">Your ambient intelligence is ready.</p></div>
